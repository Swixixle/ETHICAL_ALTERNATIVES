...
Batch 02 (Apr 6):
nestle ✅ | walmart ✅ | h-and-m ✅ | samsung ✅ | pepsico ✅ | tyson-foods ✅ | johnson-and-johnson ✅ | procter-and-gamble ✅ | uniqlo ✅

Batch 03 (Apr 6):
vale ✅ | siemens ✅ | dji ✅ | primark ✅ | tim-hortons ✅ | cemex ✅ | bosch ✅ | lindt ✅ | haier ✅ | byd ✅
...
⬜ able-cc
⬜ acer
⬜ acqua-panna (Nestlé brand — skip, use nestle profile)
⬜ acs-group
⬜ actimel (Danone)
⬜ aeolus
⬜ aero (Nestlé)
...
⬜ alpine (Renault)
⬜ alteogen
⬜ ambev (AB InBev) — use ab-inbev profile
⬜ american-express
⬜ angelina
⬜ anker
⬜ ann-demeulemeester
...
⬜ august-storck
⬜ avon-tyres
⬜ axe (Unilever) — use unilever profile
⬜ bacardi
⬜ badoit (Danone)
⬜ baic
⬜ balenciaga (Kering)
...
⬜ caffe-nero
⬜ caixabank
⬜ calvin-klein (PVH) — use pvh-corp profile
⬜ campari-group
⬜ canadian-tire
⬜ capital-one
⬜ catcher-technology
...
⬜ dove (Unilever) — use unilever profile
⬜ dreame
⬜ dunlop
⬜ ecovacs
⬜ edeka
...
⬜ kendamil
⬜ knorr (Unilever) — use unilever profile
⬜ koc-holding
⬜ kohl's
⬜ kumho
⬜ lacoste
...
⬜ yokohama
⬜ yves-rocher
⬜ zara (Inditex) ✅ — use inditex profile
⬜ zeekr (Geely)
...
Some master list entries are brands, not companies — they should resolve to a parent profile:
- Acqua Panna, Maggi, Nespresso, Perrier, Vittel → nestle
- Axe, Dove, Hellmann's, Knorr, Lipton, Persil, Sunsilk → unilever
- Bershka, Lefties, Massimo Dutti, Oysho, Pull&Bear, Stradivarius, Zara → inditex
- Beck's, Budweiser, Hoegaarden, Leffe, Stella Artois → ab-inbev
- Braun, Rexona → procter-and-gamble
- Balenciaga, Bottega Veneta → kering (separate profile needed)

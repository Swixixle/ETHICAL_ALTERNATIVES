...
async function main() {
  let total = 0;
  for (const batch of ['profiles_v3','profiles_v4','profiles_v5','profiles_v6','profiles_v7','profiles_v8','profiles_v9','profiles_v10','profiles_v11','profiles_v12','profiles_v13','profiles_v14','profiles_v15']) {
    console.log(`\nImporting ${batch}...`);
